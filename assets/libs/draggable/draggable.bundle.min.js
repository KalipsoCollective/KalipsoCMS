!(function (e, t) {
    ...
    return (function (e) {
        ...
        function (e, t, r) {
            ...
            function c(e) {
                (e.target.style.transition = ""), (e.target.style.pointerEvents = ""), e.target.removeEventListener("transitionend", c);
            }
                                ...
                                (function ({ from: e, to: t }, { duration: r, easingFunction: n }) {
                                    ...
                                    (o.style.pointerEvents = "none"),
                                        ...
                                        requestAnimationFrame(() => {
                                            o.addEventListener("transitionend", c), (o.style.transition = `transform ${r}ms ${n}`), (o.style.transform = "");
                                        });
                                })(e, this.options)
                            );
                        }));
        ...
        function (e, t, r) {
            ...
            function u(e, t, { duration: r, easingFunction: n, horizontal: o }) {
                ...
                requestAnimationFrame(() => {
                    for (const o of [e, t]) o.addEventListener("transitionend", c), (o.style.transition = `transform ${r}ms ${n}`), (o.style.transform = "");
                });
            }
            function c(e) {
                (e.target.style.transition = ""), (e.target.style.pointerEvents = ""), e.target.removeEventListener("transitionend", c);
                        ...
                        r &&
                            (0, a.requestNextAnimationFrame)(() => {
                                ...
                                (this.lastHeight === e.height && this.lastWidth === e.width) ||
                                    ((this.mirror.style.width = `${e.width}px`), (this.mirror.style.height = `${e.height}px`), (this.lastWidth = e.width), (this.lastHeight = e.height));
                            });
                    });
                }
            };
        ...
        function (e, t, r) {
            ...
            t.default = class extends i.default {
                ...
                [u](e) {
                    ...
                    const i = f({ source: t, over: r, overContainer: n, children: this.getSortableElementsForContainer(n) });
                    if (!i) return;
                ...
                [c](e) {
                    ...
                    const { source: t, over: r, overContainer: n } = e,
                        ...
                        s = new a.SortableSortEvent({ dragEvent: e, currentIndex: o, source: t, over: r });
                    if ((this.trigger(s), s.canceled())) return;
                    const i = f({ source: t, over: r, overContainer: n, children: this.getDraggableElementsForContainer(n) });
                    if (!i) return;
                    const { oldContainer: l, newContainer: u } = i,
                        c = this.index(t),
                        d = new a.SortableSortedEvent({ dragEvent: e, oldIndex: o, newIndex: c, oldContainer: l, newContainer: u });
        ...
        function (e, t, r) {
            ...
            const h = Symbol("onDragStart"),
                ...
                v = { "drag:start": (e) => `Picked up ${e.source.textContent.trim() || e.source.id || "draggable element"}`, "drag:stop": (e) => `Released ${e.source.textContent.trim() || e.source.id || "draggable element"}` },
                m = {
                ...
                b = (t.defaultOptions = { draggable: ".draggable-source", handle: null, delay: {}, distance: 0, placedTimeout: 800, plugins: [], sensors: [], exclude: { plugins: [], sensors: [] } });
            class y {
                ...
                [h](e) {
                    ...
                    this.lastPlacedSource &&
                        ...
                        (clearTimeout(this.placedTimeoutID), this.lastPlacedSource.classList.remove(...this.getClassNamesFor("source:placed")), this.lastPlacedContainer.classList.remove(...this.getClassNamesFor("container:placed"))),
                ...
                [g](e) {
                    ...
                    if (u) {
                        const e = new d.DragOutEvent({ source: this.source, originalSource: this.originalSource, sourceContainer: r, sensorEvent: t, over: this.currentOver, overContainer: this.currentOverContainer });
                ...
                [f](e) {
                    ...
                    const r = new d.DragStoppedEvent({ source: this.source, originalSource: this.originalSource, sensorEvent: e.sensorEvent, sourceContainer: this.sourceContainer });
            ...
            (t.default = y), (y.Plugins = { Announcement: i.Announcement, Focusable: i.Focusable, Mirror: i.Mirror, Scrollable: i.Scrollable }), (y.Sensors = { MouseSensor: u.MouseSensor, TouchSensor: u.TouchSensor });
        },
        function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 });
            ...
            t.default = class extends s.default {
                ...
                [h](e) {
                    if (!this.dragging) return;
                    const t = new i.DragStopSensorEvent({ clientX: e.clientX, clientY: e.clientY, target: null, container: this.currentContainer, originalEvent: e });
                ...
                [d](e) {
                    if (!this.dragging) return;
                    const t = document.elementFromPoint(e.clientX, e.clientY),
                        r = new i.DragMoveSensorEvent({ clientX: e.clientX, clientY: e.clientY, target: t, container: this.currentContainer, originalEvent: e });
                ...
                [c](e) {
                    ...
                    const t = e.target,
                        r = e.currentTarget,
                        n = new i.DragPressureSensorEvent({ pressure: e.webkitForce, clientX: e.clientX, clientY: e.clientY, target: t, container: r, originalEvent: e });
                    this.trigger(r, n);
                }
                [g](e) {
                    if (!this.dragging) return;
                    const t = e.target,
                        r = new i.DragPressureSensorEvent({ pressure: e.webkitForce, clientX: e.clientX, clientY: e.clientY, target: t, container: this.currentContainer, originalEvent: e });
                    this.trigger(this.currentContainer, r);
                }
            };
        },
        ...
        function (e, t, r) {
            ...
            t.default = class extends i.default {
                ...
                [d](e) {
                    ...
                    if ((document.removeEventListener("mouseup", this[d]), document.removeEventListener("dragstart", f), document.removeEventListener("mousemove", this[g]), !this.dragging)) return;
                    const t = document.elementFromPoint(e.clientX, e.clientY),
        ...
        function (e, t, r) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                (t.default = function (e, t) {
                    ...
                    function d(e) {
                        return e ? (a ? n.call(e, r) : u ? [...s].includes(e) : c ? i === e : l ? o(e) : null) : e;
                    }
                    let h = e;
                    do {
        ...
        function (e, t, r) {
            ...
            const u = (t.onDragStart = Symbol("onDragStart")),
                ...
                v = (t.defaultOptions = { constrainDimensions: !1, xAxis: !0, yAxis: !0, cursorOffsetX: null, cursorOffsetY: null, thresholdX: null, thresholdY: null });
            function m(e) {
                let { source: t } = e,
                    r = l(e, ["source"]);
                return _((e) => {
            ...
            function O({ withFrame: e = !1, initial: t = !1 } = {}) {
                return (r) => {
                    let { mirror: n, sensorEvent: s, mirrorOffset: i, initialY: a, initialX: u, scrollOffset: c, options: d, passedThreshX: h, passedThreshY: g, lastMovedX: f, lastMovedY: p } = r,
            ...
            t.default = class extends i.default {
                ...
                [u](e) {
                    ...
                    const l = new a.MirrorCreatedEvent({ source: t, originalSource: r, sourceContainer: n, sensorEvent: o, dragEvent: e, mirror: this.mirror }),
                        u = new a.MirrorAttachedEvent({ source: t, originalSource: r, sourceContainer: n, sensorEvent: o, dragEvent: e, mirror: this.mirror });
                ...
                [c](e) {
                    ...
                    const l = new a.MirrorMoveEvent({ source: t, originalSource: r, sourceContainer: n, sensorEvent: o, dragEvent: e, mirror: this.mirror, passedThreshX: s, passedThreshY: i });
                ...
                [h]({ mirror: e, source: t, sensorEvent: r }) {
                    ...
                    const s = { mirror: e, source: t, sensorEvent: r, mirrorClasses: n, scrollOffset: this.scrollOffset, options: this.options, passedThreshX: !0, passedThreshY: !0 };
                    return Promise.resolve(s)
                        ...
                        .then((e) => {
                            ...
                            return (this.mirrorOffset = t), (this.initialX = r), (this.initialY = n), (this.lastMovedX = r), (this.lastMovedY = n), o({ mirrorOffset: t, initialX: r, initialY: n }, s);
                        });
                }
                [g](e) {
                ...
                [a]() {
                    requestAnimationFrame(() => {
                        this.getElements().forEach((e) =>
                            (function (e) {
                                Boolean(!e.getAttribute("tabindex") && -1 === e.tabIndex) && (c.push(e), (e.tabIndex = 0));
                            })(e)
                        );
                    });
                }
        ...
        function (e, t, r) {
            ...
            const v = (function () {
                ...
                return (
                    ...
                    e.setAttribute(d, "additions"),
                    e.setAttribute(h, "true"),
                    e.setAttribute(g, "assertive"),
                    e.setAttribute(f, "log"),
        ...
        function (e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }),
                (t.DragStoppedEvent = t.DragStopEvent = t.DragPressureEvent = t.DragOutContainerEvent = t.DragOverContainerEvent = t.DragOutEvent = t.DragOverEvent = t.DragMoveEvent = t.DragStartEvent = t.DragEvent = void 0);
            var n,
                o = r(1),
                s = (n = o) && n.__esModule ? n : { default: n };
            class i extends s.default {
