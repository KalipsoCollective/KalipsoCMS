...
return [
	...
	'data'  => [
		...
		'user_roles' => [
			[
				'name'                  => 'admin',
				'routes'                => 'auth,auth/:action,auth/logout,management,management/users,management/users/list,management/users/add,management/users/:id,management/users/:id/update,management/users/:id/delete,management/roles,management/roles/list,management/roles/add,management/roles/:id,management/roles/:id/delete,management/roles/:id/update,management/sessions,management/sessions/list,management/:module,management/:module/list,management/:module/add,management/:module/:id,management/:module/:id/update,management/:module/:id/delete,management/:module/slug,management/content/:module/upload-file,management/media,management/media/list,management/media/add,management/media/:id,management/media/:id/update,management/media/:id/delete,management/menus,management/menus/list,management/menus/add,management/menus/:id,management/menus/:id/update,management/menus/:id/delete,management/menus/get-menu-params,management/forms/:form,management/forms/:form/list,management/forms/:form/:id,management/forms/:form/:id/update,management/logs,management/logs/list,management/logs/:ip/block,management/settings,management/settings/update',
				'created_at'            => time(),
				'created_by'            => 1
			]
		],
