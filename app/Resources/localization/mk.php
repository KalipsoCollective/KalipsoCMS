...
return [
    ...
    'settings' => [
        ...
        'cookie_policy' => 'Политика за колачиња',
        'cookie_policy_info' => 'Ова е страницата што треба да се користи за врската со политиката за колачиња.',
        'map_lat_lon' => 'Карта Географска географска должина',
        'map_lat_lon_info' => 'Се користи за отворање на мапата од страницата за контакт. Се внесува како „широчина, должина“.',
    ],
    'base' => [
        'byte' => 'бајт',
        'sandbox' => 'Песочник',
        ...
        'our_values_message' => 'Можете да управувате со нашата содржина на делот за вредности овде.',
        'product_info' => 'Информација за продуктот',
        'nutritional_values' => 'Нутритивни вредности',
        'center' => 'Центар',
        'contact_us' => 'Контактирајте не',
        'our_values_title' => 'Наслов на делот за нашите вредности',
        'vision_title' => 'Наслов на делот за визија',
        'mission_title' => 'Наслов на делот за мисијата',
        'vision_image' => 'Визија насловна слика',
        'mission_image' => 'Насловна слика на мисијата',
        'all_details' => 'Сите детали',
        'location' => 'Локација',
        'period' => 'Период',
        'career_title' => 'Наслов за кариера',
        'career_subtitle' => 'Превод за кариера',
        'career_image' => 'Слика за кариера',
        'x_open_position' => '[X] Отворена позиција',
        'open_positions' => 'Отворени позиции',
        'open_positions_desc' => 'Откако ќе го изберете огласот за работа, ќе ве упатиме до формуларот за апликација.',
        'upload' => 'Вчитај',
        'upload_cv' => 'Поставете резиме',
        'cv' => 'Продолжи',
        'ok' => 'Добро',
        'cookie_desc' => 'Оваа страница користи колачиња за да ги обезбеди своите услуги и да го анализира сообраќајот.',
        'get_info' => 'Добијте информации',
        'check_languages' => 'Проверете ги јазиците',
        'check_languages_message' => 'Dil dosyalarını kontrol edip karşılaştırmasını yapar.',
        'no_missing_definitions' => 'Не недостасува дефиниција.',
    ],
    'app' => [
    ]
];