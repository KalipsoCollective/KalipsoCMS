			...
			<div class="row">
				<header class="col-12 dash-header">
					<div class="d-flex align-items-center">
						<h1><i class="ti ti-cloud"></i> <?php echo \KN\Helpers\Base::lang('base.media'); ?></h1>
						<?php
						if ($this->authority('management/medias/add')) {
						?>
				...
				<div class="col-12 dash-content">
					<div class="bg-white p-2 mb-2 rounded shadow-sm" id="mediasTable"></div>
				</div>
			</div>
		</div>
		<?php
		...
		if ($this->authority('management/medias/:id')) {
		?>
