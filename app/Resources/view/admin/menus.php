			...
			<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered modal-xl">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="row g-2" data-kn-form id="menuUpdate" method="post" action="">
								<div class="form-loader">
									<div class="spinner-border text-light" role="status">
										<span class="visually-hidden"><?php echo \KN\Helpers\Base::lang('base.loading'); ?></span>
									</div>
								...
								<div class="col-12<?php if ($this->authority('management/menus/:id/update')) echo ' col-md-11'; ?>">
									<div class="form-floating">
										<input type="text" class="form-control" required name="menu_key" id="editMenuKey" placeholder="<?php echo \KN\Helpers\Base::lang('base.key'); ?>">
										<label for="editMenuKey"><?php echo \KN\Helpers\Base::lang('base.key'); ?></label>
									</div>
								</div>
								...
								<div class="kn-menu-drag" id="menuItems">
								</div>
							</form>
						</div>
						<div class="modal-footer">
							...
							?>
								<button type="submit" form="menuUpdate" class="btn btn-primary"><?php echo \KN\Helpers\Base::lang('base.update'); ?></button>
							<?php
							}	?>
						</div>
					</div>
