			...
			<div class="row">
				<header class="col-12 dash-header">
					<div class="d-flex align-items-center">
						<h1><i class="ti ti-settings"></i> <?php echo \KN\Helpers\Base::lang('base.settings'); ?></h1>
					</div>
					<p><?php 
						echo $description; 
						echo '
				...
				<div class="col-12 dash-content">
					<div class="bg-white p-2 mb-2 rounded shadow-sm">
						<div class="row">
							<div class="col-12">
								<form class="row g-2 mb-3" data-kn-form id="settingsUpdate" method="post" action="<?php echo $this->url('management/settings/update'); ?>">
