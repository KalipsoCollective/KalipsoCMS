    ...
    public static function filter($data = null, $parameter = 'text') {
        ...
        if (is_array($data)) {
            ...
            switch ($parameter) {
                ...
                case 'slug':
                    $data = empty($data) ? null : self::slugGenerator(strip_tags((string)trim($data))); 
                    break;
