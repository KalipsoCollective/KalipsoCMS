		...
		$groups = [
			'basic' => [
				...
				'items' => [
					...
					'map_embed_url' => [
						'type' => 'input',
						'value' => Base::config('settings.map_embed_url'),
						'name' => Base::lang('settings.map_embed_url'),
						'info' => Base::lang('settings.map_embed_url_info'),
					],
					'map_lat_lon' => [
						'type' => 'input',
						'value' => Base::config('settings.map_lat_lon'),
						'name' => Base::lang('settings.map_lat_lon'),
						'info' => Base::lang('settings.map_lat_lon_info'),
					],
					'clarification_text' => [
						'type' => 'select',
						'value' => Base::config('settings.clarification_text'),
						'options' => $pages,
						'required' => true,
						'numeric' => true,
						'name' => Base::lang('settings.clarification_text'),
						'info' => Base::lang('settings.clarification_text_info'),
					],
					'cookie_policy' => [
						'type' => 'select',
						'value' => Base::config('settings.cookie_policy'),
						'options' => $pages,
						'required' => true,
						'numeric' => true,
						'name' => Base::lang('settings.cookie_policy'),
						'info' => Base::lang('settings.cookie_policy_info'),
					],
					'address' => [
						'type' => 'input',
						'value' => Base::config('settings.address'),
						'name' => Base::lang('settings.address'),
						'info' => Base::lang('settings.address_info'),
					],
					'phone' => [
						'type' => 'input',
						'value' => Base::config('settings.phone'),
						'name' => Base::lang('settings.phone'),
						'info' => Base::lang('settings.phone_info'),
					],
					'facebook' => [
						'type' => 'input',
						'value' => Base::config('settings.facebook'),
						'name' => Base::lang('settings.facebook'),
						'info' => Base::lang('settings.facebook_info'),
					],
					'twitter' => [
						'type' => 'input',
						'value' => Base::config('settings.twitter'),
						'name' => Base::lang('settings.twitter'),
						'info' => Base::lang('settings.twitter_info'),
					],
					'linkedin' => [
						'type' => 'input',
						'value' => Base::config('settings.linkedin'),
						'name' => Base::lang('settings.linkedin'),
						'info' => Base::lang('settings.linkedin_info'),
					],
					'instagram' => [
						'type' => 'input',
						'value' => Base::config('settings.instagram'),
						'name' => Base::lang('settings.instagram'),
						'info' => Base::lang('settings.instagram_info'),
					],
					'default_user_role' => [
						'type' => 'select',
